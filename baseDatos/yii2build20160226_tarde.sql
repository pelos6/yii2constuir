...
CREATE TABLE IF NOT EXISTS `gender` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `status` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `status_name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `status_value` smallint(6) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
