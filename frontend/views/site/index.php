...
<div class="site-index">
    ...
    <div class="site-index">
        <div class="jumbotron">
            ...
            <h1>Yii 2 Build <i class="fa fa-bicycle"></i></h1>
            <p class="lead">Use this Yii 2 Template to start Projects. <span class="fa fa-bicycle"></span></p>
            <br/>
            <?php
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p>
                        <?php
                        if (!Yii::$app->user->isGuest) {
                            echo Yii::$app->user->identity->username . '<span class="fa fa-bicycle"> </span> is doing cool stuff. ';
                        }
                        ?>
